...
Two adjacent polygons duplicate their shared boundary — wasteful in memory and
requiring expensive spatial predicates (GEOS) to rediscover adjacency.
...
| [gibble](https://CRAN.R-project.org/package=gibble) | CRAN | Path/geometry indexing — conceptually similar to wkpool's segment provenance |
...
|---------|-------|----------|
| [spdep](https://CRAN.R-project.org/package=spdep) | CRAN | `poly2nb()` for queen/rook contiguity — computes on-demand |
...
| Package | Where | Notes |
|---------|-------|-------|
| [vapour](https://CRAN.R-project.org/package=vapour) | CRAN | Low-level GDAL geometry access |
| [geodist](https://CRAN.R-project.org/package=geodist) | CRAN | Fast distances for tolerance-based merging |
| [controlledburn](https://github.com/hypertidy/controlledburn) | GitHub | Rasterization using topology |
